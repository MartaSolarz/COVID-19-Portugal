...
def update(frame):
    ...
    ax.set_ylim(0, 105)
    ax.set_title(f'Progress on vaccination against COVID-19 in Portugal - {df_vaccinations.index[frame].strftime("%m.%Y")}', fontweight='bold')
...
ani.save('../plots/7_vaccinations_animation.gif', writer='imagemagick', fps=3, dpi=150)